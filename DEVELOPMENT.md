...
```bash
git remote add encore encore://supply-chain-mrp-system-b57i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/supply-chain-mrp-system-b57i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/supply-chain-mrp-system-b57i/settings/integrations/github)
